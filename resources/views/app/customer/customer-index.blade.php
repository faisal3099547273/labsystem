...
<section class="app-user-list">
  ...
  <div class="card">
    <div class="card-datatable table-responsive pt-0">
      ...
      <button type="button" class="btn btn-success" onclick="importModal()">Import</button>
    </div>
      {{ $dataTable->table() }}
    </div>
...
<script src="{{ asset(mix('vendors/js/forms/select/select2.full.min.js')) }}"></script>
  ...
  <script>
    $("#select2Demo").select2({ dropdownParent: "#editUser" });
    $("#single").select2({ dropdownParent: "#importUser" });
...
$("#select-user").change(function(){
 var val = $("#select-user").val();
 if(val == 1){
  $("#single-user1").removeClass('d-none');
 }else{

  $("#single-user1").addClass('d-none');
